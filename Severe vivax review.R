...
# Data version	: 10-08-2021 (from APP)
# Script Date	: 10-08-2021
#=================================================================
#rm(list=ls())
library(readxl)
...
setwd("D:/severe_pv_review")

#=================================
# Read data 
#=================================
dat0 <- read_excel("Table S2. List of articles included for review_revision for meta-analysis 10082021.xlsx", 
...
#-----------------------------------------
# Bias adjustement separately by region
#-----------------------------------------
# Africa only
...
metabias(meta.prop.afr, k.min=5)
